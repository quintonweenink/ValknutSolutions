...
\section{Introduction}
	...
	Insurance profiling as it is currently specified is an application that will allow insurance companies to get data from lead data provided via lead advertisements on facebook. This data will be used to charge the uses for the  insuance that they have signed up for while also providing the application with some basic data that can later be used to analise the users and the data they provided in order to give the insuance company with a risk profile they can use to charge and adapt their sale and costs.\\
