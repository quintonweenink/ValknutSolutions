	...
	\subsection{Integration requirements}
		\subsubsection{API specifications}
			...
			\begin{itemize}
				...
				\item Logging peopole in
					The method of how to log people in
				\item Confirming identity
					Making sure the identity of our application is correct to prevent cross site scripting
				\item Storing access tokens \& login status
					To be able to access the users account at a later time to update data to our database
				\item Logging people out
					Once we have updated our database we should log the user out.
			\end{itemize}
