...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			\includegraphics[width=10cm]{images/logo.png}  \\%Change to our own logo instead of the UP logo
			[0.5cm]
			\huge{
	...
	\begin{versionhistory}
  		...
  		\vhEntry{1.2}{11.10.2016}{CJvV,KH,QW}{Updated according to feedback. Added new functionality manual.}
	\end{versionhistory}	
