...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			\includegraphics[width=10cm]{images/UP.jpg}  \\%Change to our own logo instead of the UP logo
			[0.5cm]
			\huge{
	...
	\begin{versionhistory}
  		...
  		\vhEntryh{1.2}{11.10.2016}{CJvV,KH,QW}{Updated according to feedback. Added new functionality manual.}
	\end{versionhistory}	
	...
	\section{General Information}
		\subsection{System Overview} %Too vague for outsider to understand state what kind of info is gathered and who will have an interest in this info with its benifits. State what system provides to assist the interested party.
		...
		\subsection{System Configuration}%extended to mention the info resources that are connected. Image of web server connected to different source to provide info and some client machines connected to the server
		...
		\subsection{Installation}%Refer user to browser settings on chrome and firefox web sites to activate the necesarry settings for their browser to work correctly with our system
