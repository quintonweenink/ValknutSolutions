...
\begin{document}
	...
	\begin{versionhistory}
  		...
  		\vhEntry{1.4}{05.11.2016}{CJvV,KH,QW}{Added Logo, added Validation tests to all necessary sections, added new figures for messenger and validation tests, added Authentication test with figure}
	\end{versionhistory}	
...
12        &  Architectural requirements - Security and Auditability & 12        \\ \hline
\end{tabular}
\end{table}
